    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .insert([{
          ...
          labour_start: run.labourStart || null,
          labour_end: run.labourEnd || null,
          labour_people: run.labourPeople || null,
          labour_rate_per_hour: run.labourRate || null,
  ...
  async updateProductionRun(run) {
    ...
    try {
      const updateData = {
        ...
        labour_start: run.labour_start,
        labour_end: run.labour_end,
        labour_people: run.labour_people,
        labour_rate_per_hour: run.labour_rate_per_hour,
